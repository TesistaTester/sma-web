			...
			<div class="col-md-12">
				...
				<div class="card">
					<div class="row no-gutters">
						<div class="col-md-12">
							<div class="card-body">
								<form id="form-nuevo-personal" action="{{url('unidades/'.$unidad->uor_id)}}" method="POST">
								  @method('PUT')
								  @csrf
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														...
														<select required class="form-control @error('uor_superior') is-invalid @enderror" name="uor_superior" id="uor_superior">
															...
															<option value="9999999" {{ old('uor_superior', $unidad->uor_superior) == 9999999 ? 'selected' : '' }}>Ninguna</option>
															@foreach ($unidades as $item)
															<option value="{{$item->uor_id}}" {{ old('uor_superior', $unidad->uor_superior) == $item->uor_id ? 'selected' : '' }}>{{$item->uor_nombre}}</option>
															@endforeach
														</select>
														@error('uor_superior')
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<input required type="text" value="{{old('uor_nombre', $item->uor_nombre)}}" class="form-control @error('uor_nombre') is-invalid @enderror" name="uor_nombre" id="uor_nombre" placeholder="Nombre sección o unidad">
														@error('uor_nombre')
														<div class="invalid-feedback">
															{{$message}}
														</div>											
