			...
			<div class="col-md-12">
				...
				<div class="card">
					<div class="row no-gutters">
						<div class="col-md-12">
							<div class="card-body">
								<form id="form-nuevo-inspeccion" action="{{url('inspecciones/'.$inspeccion->ins_id)}}" method="POST">
								  @csrf
								  @method('PUT')
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														...
														<input required type="text" value="{{old('ins_nombre', $inspeccion->ins_nombre)}}" class="form-control @error('ins_nombre') is-invalid @enderror" name="ins_nombre" id="ins_nombre" placeholder="Nombre o titulo inspeccion">
														@error('ins_nombre')
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<textarea required class="form-control @error('ins_descripcion') is-invalid @enderror" name="ins_descripcion" id="ins_descripcion" cols="30" rows="10">{{old('ins_descripcion', $inspeccion->ins_descripcion)}}</textarea>
