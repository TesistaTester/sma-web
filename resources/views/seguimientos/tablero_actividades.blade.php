            ...
            <select required name="tap_id" class="form-control">
                ...
                <?php endforeach;?>
					...
					<div class="form-group">
							...
							<i class="fa fa-question-circle float-right" title="Establecer horas - hombre empleadas en la tarjeta concluida"></i>
							</label>
              Hrs:
              <input required type="number" min="0" max="100" value="0" class="form-control" name="tap_horas_hombre" id="tap_horas_hombre" style="display:inline; width:100px;">
              Min:
              <input required type="number" min="0" max="60" value="0" class="form-control" name="tap_minutos_hombre" id="tap_minutos_hombre" style="display:inline; width:100px;">
					</div>
        </div>
        <div class="modal-footer">
          <input type="hidden" name="ort_id" value="{{$orden->ort_id}}">
