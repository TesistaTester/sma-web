					...
					<div class="row no-gutters">
						<div class="col-md-12">
							<div class="card-body">
								...
								<br>
								<form id="form-nueva-actividad" action="{{url('tarjetas/'.$tarjeta->tar_id.'/nueva_actividad')}}" method="POST">
								  @csrf
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														...
														<input required type="text" value="{{old('tac_descripcion')}}" class="form-control @error('tac_descripcion') is-invalid @enderror" name="tac_descripcion" id="tac_descripcion" placeholder="Titulo o descripcion">
