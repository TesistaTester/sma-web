												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<small class="text-info">
															Copiar esta contraseña antes de guardar.
														</small>											
														@error('usu_password')
														<div class="invalid-feedback">
															{{$message}}
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<input required type="text" value="{{old('usu_email')}}" class="form-control txt_email @error('usu_email') is-invalid @enderror" name="usu_email" id="usu_email" placeholder="Correo electrónico">
														@error('usu_email')
														<div class="invalid-feedback">
															{{$message}}
														</div>											
