			...
			<div class="col-md-12">
				...
				<div class="card">
					<div class="row no-gutters">
						<div class="col-md-12">
							<div class="card-body">
								<form id="form-nuevo-personal" action="{{url('cargos/'.$cargo->car_id)}}" method="POST">
								  @method('PUT')
								  @csrf
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														...
														<select required class="form-control @error('uor_id') is-invalid @enderror" name="uor_id" id="uor_id">
															...
															<option value="{{$item->uor_id}}" {{ old('uor_id', $cargo->uor_id) == $item->uor_id ? 'selected' : '' }}>{{$item->uor_nombre}}</option>
															@endforeach
														</select>
														@error('uor_id')
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<input required type="text" value="{{old('car_nombre', $cargo->car_nombre)}}" class="form-control @error('car_nombre') is-invalid @enderror" name="car_nombre" id="car_nombre" placeholder="Nombre sección o unidad">
														@error('car_nombre')
														<div class="invalid-feedback">
															{{$message}}
														</div>											
